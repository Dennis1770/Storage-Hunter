...
{
    //Script written by Andrew & Michael. Michael made edits to this script to have it work cohesively with the DialogueManager.  Also added noiseValue for the monster to use.
